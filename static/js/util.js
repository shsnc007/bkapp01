...
const paramsUnit = [
    ...
    {"params":{"pagination":{"pagenum":1,"pagesize":40,"sort":{}},"condition":{"alarmId":"","businessIds":[],"deviceTypeIds":[],"hostIp":"","hostName":"","alarmInfo":"","resourceGroupIds":[],"itemName":"","value":"","priorityList":[],"precise":false,"hostIds":[],"handleStatus":1,"lastClockStartTime":"","lastClockEndTime":"","maintenancesFlag":"","searchHistoryType":[],"remindType":false}}},
    //获取监控性能最新数据
    
     {params:{"pagination":{"pagenum":1,"pagesize":"10","sort":{}},"condition":{"hostid":"127"}}},
    //执行操作的基本信息
    {params:{"id":2896}},
    //执行操作日志信息
...
$.postJSON = function( data, callback) {
    ...
    if (data.index) {
        data.amp_url = 'http://52.81.101.159:8083';
        data.amp_user = 'admin';
